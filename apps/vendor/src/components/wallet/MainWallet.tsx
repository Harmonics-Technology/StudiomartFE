      ...
      <Box>
        <Box bgColor="white">
          ...
          >
            ...
            <Button bgColor="brand.100" color="white" px="2rem" onClick={open}>
          ...
          >
            ...
            <VStack h="full" justify="space-between" pb="3rem">
              {studioTransactions?.value?.length == 0 ? (
                ...
                <VStack spacing={0} gap="1.9rem" w="full" align="flex-start">
                  {studioTransactions?.value?.map((info: TransactionView) => (
                    <RecentTransaction
                      key={info.bookingId}
