          ...
          <VStack w="full" gap="5rem" spacing={0}>
            {bookings?.value?.map((x) => (
              ...
              >
                ...
                <Box pt="2.5rem" borderRight="1px solid #e5e5e5">
                  <InfoBox
                  ...
                  <Box mt="2rem">
                    <InfoBox
                      title="Date and Time"
                      desc={`${dayjs(x.date).format("DD/MM/YYYY")} - ${dayjs(
                  ...
                  <HStack w="full">
                    ...
                    <Button bgColor="yellow.500" color="white" borderRadius="0">
                      <Icon as={AiFillHeart} />
                    </Button>
                  </HStack>
                </Box>
                <Box pl="1.5rem" mt="1rem">
                  <ResponseBox response={x.status?.toLowerCase()} />
                  <InfoBox title="Studio Name" desc={x.service?.studio?.name} />
                  <InfoBox
